"""This module defines the analysis for 3-qubit state tomography with readout mitigation and MLE."""
...
class ThreeQStateTomographyAnalysisOptions:
    """Options for 3Q tomography analysis."""
...
@workflow.workflow(name="analysis_three_qubit_state_tomography")
def analysis_workflow(
    ...
    target_state=None,
    options: ThreeQStateTomographyAnalysisOptions | None = None,
) -> None:
    """Run IQ-probability readout-mitigated MLE analysis for 3Q tomography data."""
    options = ThreeQStateTomographyAnalysisOptions() if options is None else options
