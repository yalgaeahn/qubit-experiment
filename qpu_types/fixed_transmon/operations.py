...
class FixedTransmonOperations(dsl.QuantumOperations):
    """Operations for FixedTransmonQubits."""

    QUBIT_TYPES = FixedTransmonQubit
    ...
    @dsl.quantum_operation
    def delay(self, q: FixedTransmonQubit, time: float) -> None:
    ...
    @dsl.quantum_operation
    def z90(self, q: FixedTransmonQubit, transition: str | None = None) -> None:
    ...
    @dsl.quantum_operation
    def z180(self, q: FixedTransmonQubit, transition: str | None = None) -> None:
