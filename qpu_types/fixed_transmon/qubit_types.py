...
"""Fixed transmon qubits and parameters."""
...
class FixedTransmonQubitParameters(QuantumParameters):
...
@classformatter
@attrs.define
class FixedTransmonQubit(QuantumElement):
    """A class for a superconducting, flux-tuneable Transmon Qubit."""

    PARAMETERS_TYPE = FixedTransmonQubitParameters
