...
"""This module defines the IQ_traj experiment.
...
from laboneq.simple import AveragingMode,AcquisitionType, Experiment, dsl
...
class IQTrajExperimentWorkflowOptions:
...
@workflow.workflow(name="iq_traj")
def experiment_workflow(
    ...
    | None = None,
    options: IQTrajExperimentWorkflowOptions | None = None,
) -> None:
...
def create_experiment(
    ...
    qubits: QuantumElements,
    states: Sequence[str],
    options: IQTrajExperimentOptions | None = None,
) -> Experiment:
    ...
    opts = IQTrajExperimentOptions() if options is None else options
