"""Canonical three-qubit QST workflows under the `three_qubit_state_tomography` name.
...
from qubit_experiment.analysis.three_qubit_state_tomography import (
...
@workflow.workflow(name="three_qubit_state_tomography_convergence")
...
@workflow.workflow(name="three_qubit_state_tomography_shot_sweep")
...
def _validate_bundle_configuration(
    ...
    if (
        ...
        raise ValueError(
            "Analysis-capable three_qubit_state_tomography bundles require readout calibration. "
