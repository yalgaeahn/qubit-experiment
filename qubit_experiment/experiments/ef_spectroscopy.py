...
from laboneq_applications.core.validation import validate_and_convert_qubits_sweeps, validate_and_convert_single_qubit_sweeps
...
@workflow.workflow(name="ef_spectroscopy")
...
def create_experiment(
    ...
    q, frequencies = validate_and_convert_single_qubit_sweeps(qubits, frequencies)
