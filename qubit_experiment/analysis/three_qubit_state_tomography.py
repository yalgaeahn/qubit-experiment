"""Canonical three-qubit QST analysis under the `three_qubit_state_tomography` name.
...
def plot_convergence_suite_fidelity(
    ...
    ax.grid(alpha=0.3)
    fig.tight_layout()
    workflow.save_artifact("three_qubit_state_tomography_convergence_fidelity", fig)
...
def plot_shot_sweep_summary(
    ...
    fig.tight_layout()
    workflow.save_artifact("three_qubit_state_tomography_shot_sweep_summary", fig)
